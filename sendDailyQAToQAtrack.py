...
resp_daily=upload_unittest_results_to_QAtrack(root_api_url, unit_test_collection_instance_url,qatrack_user_token, qa_results_json,upload_fequency='qatime')



print(resp_daily.json)
...
resp_monthly=upload_unittest_results_to_QAtrack(root_api_url, unit_test_collection_instance_url,qatrack_user_token, qa_results_json,upload_fequency='qatime')


print(resp_monthly.json())
